...
// PIFAN 2020年12月16日15:20:06 这里为什么要用特意用extern引用别处的函数？先将这里注释掉了
...
class Component{
	...
	protected:
		...
		//---------------------------------------------------------
		// PiFan:below is the function add by myself;
		// 检测到二维码时候的状态
        virtual void CollectDataState();
		// 根据检测到二维码的定位数据标定里程计的状态
		virtual void CalibrateOdomState();

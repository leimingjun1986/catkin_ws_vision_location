...
/*!	\fn void Component::AllState()
 *	\brief Actions performed on collect data states
*/
void Component::CollectDataState(){

}


/*!	\fn void Component::AllState()
 *	\brief Actions performed on calibrate  odom states
*/
void Component::CalibrateOdomState(){
...
char *Component::GetStateString(){
	switch(iState){
		...
		break;
		case COLLECT_DATA_STATE:
			return (char *)"COLLECT_DATA_STATE";
		break;
		case CALIBRATE_ODOM_STATE:
			return (char *)"CALIBRATE_ODOM_STATE";
		break;
		default:
			return (char *)"UNKNOWN";
		break;
